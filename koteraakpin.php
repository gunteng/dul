...
function change(){
        ...
        echo "\n".color("yellow","!] Claim voc BELANJAHEMAT");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        }
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"BELANJAHEMAT"}');
        ...
        sleep(3);
        $boba19 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOODSANTAI19"}');
        ...
        $expired4 = getStr1('"expiry_date":"','"',$cekvoucher,'4');
         ...
         echo color("red","========( PIN ANDA = 343434 )========")."\n";
         $data2 = '{"pin":"343434"}';
